...
func (in *CalicoConfig) DeepCopyInto(out *CalicoConfig) {
	*out = *in
	...
	if in.CalicoIPPools != nil {
		in, out := &in.CalicoIPPools, &out.CalicoIPPools
		*out = make([]CalicoIPPool, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CalicoIPPool) DeepCopyInto(out *CalicoIPPool) {
	*out = *in
	if in.CalicoIPPoolAllowedUses != nil {
		in, out := &in.CalicoIPPoolAllowedUses, &out.CalicoIPPoolAllowedUses
		*out = make([]CalicoIPPoolAllowedUse, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CalicoIPPool.
func (in *CalicoIPPool) DeepCopy() *CalicoIPPool {
	if in == nil {
		return nil
	}
	out := new(CalicoIPPool)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LoadBalancerConfig) DeepCopyInto(out *LoadBalancerConfig) {
	*out = *in
	...
	if in.CalicoConfig != nil {
		in, out := &in.CalicoConfig, &out.CalicoConfig
		*out = new(CalicoConfig)
		(*in).DeepCopyInto(*out)
	}
